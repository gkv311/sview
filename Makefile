...
sView_LIB  := $(LIB) -lStGLWidgets -lStShared -lStCore -lStImageViewer -lStMoviePlayer -lStDiagnostics -lStCADViewer $(LIB_OUTPUTS) $(LIB_GTK) -lX11 -ldl -lgthread-2.0 $(LIB_PTHREAD)
ifdef WITH_OCCT
sView_LIB += $(LIB_OCCT)
endif
$(sView) : $(sView_OBJS)
