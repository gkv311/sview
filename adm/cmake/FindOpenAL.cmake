...
if (ANDROID AND EXISTS "${OPENAL_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}/libopenal.so")
  set (OPENAL_LIBRARY_DIR_FOUND ON)
  set (OPENAL_LIBRARY_DIR "${OPENAL_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}")
  set (OPENAL_IMPLIB_SUFFIX ${CMAKE_SHARED_LIBRARY_SUFFIX})
elseif (ANDROID AND EXISTS "${OPENAL_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}/libopenal.a")
  set (OPENAL_LIBRARY_DIR_FOUND ON)
  set (OPENAL_LIBRARY_DIR "${OPENAL_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}")
elseif (MINGW AND EXISTS "${OPENAL_LIBRARY_DIR}/lib${OPENAL_TKNAME}.dll.a")
  set (OPENAL_LIBRARY_DIR_FOUND ON)
  set (OPENAL_IMPLIB_SUFFIX ".dll.a")
elseif (EXISTS "${OPENAL_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}${OPENAL_TKNAME}${CMAKE_STATIC_LIBRARY_SUFFIX}")
  set (OPENAL_LIBRARY_DIR_FOUND ON)
...
if (OPENAL_INCLUDE_DIR_FOUND AND OPENAL_LIBRARY_DIR_FOUND)
  ...
  if (OPENAL_FOUND)
    get_filename_component (OPENAL_LIBRARY_DIR "${OPENAL_LIBRARY}" DIRECTORY)
    add_library (openal SHARED IMPORTED)
    set_property (TARGET openal APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
