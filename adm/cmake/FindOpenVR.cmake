...
if (EXISTS "${OPENVR_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}openvr_api${CMAKE_STATIC_LIBRARY_SUFFIX}")
...
if (WIN32)
  if (EXISTS "${OPENVR_BINARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}openvr_api${CMAKE_SHARED_LIBRARY_SUFFIX}")
    set (OPENVR_SHAREDLIB_FOUND ON)
  endif()
else()
  if (EXISTS "${OPENVR_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}openvr_api${CMAKE_SHARED_LIBRARY_SUFFIX}")
    set (OPENVR_SHAREDLIB_FOUND ON)
  endif()
endif()
...
if (OPENVR_INCLUDE_DIR_FOUND AND OPENVR_LIBRARY_DIR_FOUND)
  ...
  foreach (aLibIter ${OPENVR_TKLIST})
    ...
    if (OPENVR_SHAREDLIB_FOUND)
      if (WIN32)
        set_target_properties (${aLibIter} PROPERTIES IMPORTED_LOCATION "${OPENVR_BINARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}${aLibIter}${CMAKE_SHARED_LIBRARY_SUFFIX}")
      else()
  ...
  if (LIBVR_FOUND)
    ...
    set (OPENVR_BINARY_DIR   "${LIBVR_LIBRARY_DIRS}")
    foreach (aLibIter ${OPENVR_TKLIST})
      add_library (${aLibIter} SHARED IMPORTED)
      set_property (TARGET ${aLibIter} APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      set_target_properties (${aLibIter} PROPERTIES IMPORTED_IMPLIB "${OPENVR_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}${aLibIter}${OPENVR_IMPLIB_SUFFIX}")
