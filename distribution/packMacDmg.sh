...
#
# Copyright © Kirill Gavrilov, 2011-2026
...
aSystem=`uname -s`
#prebuiltApp=temp/builds/sview-macos-arm64.zip
prebuiltApp=temp/builds/sView.app
...
mkdir -p $buildRoot/sView.app
cp -f media/sView_SetupMac.png $buildRoot/.background/
cp -f -R $prebuiltApp/Contents $buildRoot/sView.app/Contents
xattr -c $buildRoot/sView.app
